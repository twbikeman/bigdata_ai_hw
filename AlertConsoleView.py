...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.siteTableWidget = QtWidgets.QTableWidget(self.groupBox_4)
        self.siteTableWidget.setGeometry(QtCore.QRect(10, 40, 256, 101))
        self.siteTableWidget.setRowCount(3)
        self.siteTableWidget.setColumnCount(1)
        self.siteTableWidget.setObjectName("siteTableWidget")
        item = QtWidgets.QTableWidgetItem()
        self.siteTableWidget.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.siteTableWidget.setItem(1, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.siteTableWidget.setItem(2, 0, item)
        self.siteTableWidget.horizontalHeader().setVisible(False)
        self.siteTableWidget.verticalHeader().setVisible(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        __sortingEnabled = self.siteTableWidget.isSortingEnabled()
        self.siteTableWidget.setSortingEnabled(False)
        item = self.siteTableWidget.item(0, 0)
        item.setText(_translate("MainWindow", "場域"))
        item = self.siteTableWidget.item(1, 0)
        item.setText(_translate("MainWindow", "影片"))
        item = self.siteTableWidget.item(2, 0)
        item.setText(_translate("MainWindow", "影像"))
        self.siteTableWidget.setSortingEnabled(__sortingEnabled)
